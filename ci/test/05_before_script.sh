...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/BitcoinVG
else
  DOCKER_EXEC echo \> \$HOME/.bitcoinvg
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/bitcoinvg/bitcoinvg/pull/18288#discussion_r433189350 for
  # details.
