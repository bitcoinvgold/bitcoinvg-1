# Bootstrappable BitcoinVG Core Builds

This directory contains the files necessary to perform bootstrappable BitcoinVG
Core builds.
...
- 24GB of free disk space on the partition that the BitcoinVG Core git repository
  resides in
...
For a BitcoinVG Core depends development environment, simply invoke
...
From the top of a clean BitcoinVG Core repository:
...
To use dongcarl's substitute server for BitcoinVG Core builds after having
