...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitcoinvg repository."
  exit 1
fi
...
# See https://github.com/bitcoinvg/bitcoinvg/issues/16064
...
echo 'When compiling bitcoinvgd, run `./configure` in the following way:'
echo
