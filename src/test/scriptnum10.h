...
#ifndef BITCOINVG_TEST_SCRIPTNUM10_H
#define BITCOINVG_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinVG Core 0.10.0, for cross-comparison.
 */
public:
