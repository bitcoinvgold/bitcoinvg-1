...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinvgcore.org", "www.bitcoinvgcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinvgcore.org]", "www.bitcoinvgcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinvgcore.org:80", "www.bitcoinvgcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinvgcore.org]:80", "www.bitcoinvgcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:32950", "127.0.0.1", 32950));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:32950", "127.0.0.1", 32950));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:32950", "::ffff:127.0.0.1", 32950));
    BOOST_CHECK(TestSplitHost("[::]:32950", "::", 32950));
    BOOST_CHECK(TestSplitHost("::32950", "::32950", -1));
    BOOST_CHECK(TestSplitHost(":32950", "", 32950));
    BOOST_CHECK(TestSplitHost("[]:32950", "", 32950));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:32950", "127.0.0.1:32950"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:32950", "[::]:32950"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
