...
#ifndef BITCOINVG_CRYPTO_CHACHA_POLY_AEAD_H
#define BITCOINVG_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitcoinvg.
 *
 ...
 *
 * The chacha20-poly1305@bitcoinvg combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitcoinvg cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitcoinvg are relatively fast in
...
#endif // BITCOINVG_CRYPTO_CHACHA_POLY_AEAD_H
