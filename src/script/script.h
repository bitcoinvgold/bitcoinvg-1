...
#ifndef BITCOINVG_SCRIPT_SCRIPT_H
#define BITCOINVG_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BitcoinVG always counted CHECKMULTISIGs
...
#endif // BITCOINVG_SCRIPT_SCRIPT_H
