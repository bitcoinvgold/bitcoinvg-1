...
#ifndef BITCOINVG_COMPAT_ASSUMPTIONS_H
#define BITCOINVG_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "BitcoinVG cannot be compiled without assertions."
#endif
...
#endif // BITCOINVG_COMPAT_ASSUMPTIONS_H
