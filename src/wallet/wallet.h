...
#ifndef BITCOINVG_WALLET_WALLET_H
#define BITCOINVG_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinvg node, and set to 0 for transactions that were created
...
#endif // BITCOINVG_WALLET_WALLET_H
