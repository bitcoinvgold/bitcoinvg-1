...
#ifndef BITCOINVG_WALLET_SCRIPTPUBKEYMAN_H
#define BITCOINVG_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BitcoinVG Core wallet was originally a collection of unrelated private
...
#endif // BITCOINVG_WALLET_SCRIPTPUBKEYMAN_H
