...
#ifndef BITCOINVG_WALLET_WALLETUTIL_H
#define BITCOINVG_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitcoinvg from opening the wallet, thinking it was newly created, and
...
#endif // BITCOINVG_WALLET_WALLETUTIL_H
