...
#ifndef BITCOINVG_UTIL_SETTINGS_H
#define BITCOINVG_UTIL_SETTINGS_H
...
//!       https://github.com/bitcoinvg/bitcoinvg/pull/15934/files#r337691812)
...
#endif // BITCOINVG_UTIL_SETTINGS_H
