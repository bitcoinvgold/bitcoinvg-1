...
#ifndef BITCOINVG_UTIL_MESSAGE_H
#define BITCOINVG_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bitcoinvg address, it must refer to a public key.
...
#endif // BITCOINVG_UTIL_MESSAGE_H
