 ...
 */
#ifndef BITCOINVG_UTIL_SYSTEM_H
#define BITCOINVG_UTIL_SYSTEM_H
...
extern const char * const BITCOINVG_CONF_FILENAME;
extern const char * const BITCOINVG_SETTINGS_FILENAME;
