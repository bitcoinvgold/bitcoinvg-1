    ...
    mapper(nullptr)
{
    ...
    ui->bitcoinvgAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitcoinvgAtStartup);
    ...
    ui->bitcoinvgAtStartup->setToolTip(ui->bitcoinvgAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitcoinvgAtStartup->setText(ui->bitcoinvgAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitcoinVGConfButton->setToolTip(ui->openBitcoinVGConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitcoinVGUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinvgAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinVGConfButton_clicked()
{
