...
#ifndef BITCOINVG_QT_GUIUTIL_H
#define BITCOINVG_QT_GUIUTIL_H
...
/** Utility functions used by the BitcoinVG Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitcoinvg:" URI into recipient object, return true on successful parsing
