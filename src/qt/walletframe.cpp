...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, BitcoinVGGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &BitcoinVGGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &BitcoinVGGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &BitcoinVGGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &BitcoinVGGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &BitcoinVGGUI::updateWalletStatus);
    connect(gui, &BitcoinVGGUI::setPrivacy, walletView, &WalletView::setPrivacy);
