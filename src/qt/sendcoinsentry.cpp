    ...
    platformStyle(_platformStyle)
{
    ...
    // normal bitcoinvg address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying bitcoinvg address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BitcoinVGAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
