...
//! Entry point for BitcoinVGApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitcoinVGApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitcoinVGGUI tests.
void AppTests::guiTests(BitcoinVGGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitcoinVGGUI::consoleShown, this, &AppTests::consoleTests);
