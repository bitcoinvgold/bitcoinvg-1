...
#ifndef BITCOINVG_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOINVG_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOINVG_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
