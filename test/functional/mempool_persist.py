...
By default, bitcoinvgd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinVGTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcoinvgd from writing mempool.dat to disk. Verify that `savemempool` fails")
