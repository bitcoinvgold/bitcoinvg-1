...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinVGTestFramework
    pass


class ExampleTest(BitcoinVGTestFramework):
    # Each functional test is a subclass of the BitcoinVGTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinVGTestFramework class so other tests can use it."""
