...
class P2PPermissionsTests(BitcoinVGTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitcoinvgconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bitcoinvgconf, 'w', encoding="utf8") as f:
            f.write(newText)
