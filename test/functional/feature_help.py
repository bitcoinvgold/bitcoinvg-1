...
"""Verify that starting bitcoinvg with -h works as expected."""

from test_framework.test_framework import BitcoinVGTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinVGTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinvg with -h for help text")
        ...
        self.log.info("Start bitcoinvg with -version for version information")
        ...
        self.log.info("Start bitcoinvgd with -fakearg to make sure it does not start")
