...
// bitcoinvg includes.
#include <..\src\script\bitcoinvgconsensus.h>
...
int main()
{
    std::cout << "bitcoinvgconsensus version: " << bitcoinvgconsensus_version() << std::endl;
    ...
    auto op0Result = bitcoinvgconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bitcoinvgconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
