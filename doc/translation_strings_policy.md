...
This document provides guidelines for internationalization of the BitcoinVG Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinvg_en.ts` remains unchanged.
